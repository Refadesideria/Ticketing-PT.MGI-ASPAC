...
<div class="container">
    <div class="row">
        <div class="col-md-4">
            <a href="{{ route('unit.create')}}" class="btn btn-rounded btn-primary btn-sm"><span class="fa fa-plus"></span>&nbsp;{{__('Add Unit')}}</a>
        </div>
        {{--<div class="col-md-8">
                            ...
                            <tbody>
                                @foreach($unit as $key => $value)
                                    <tr>
                                        ...
                                        <td> <a href="{{route('unit.edit', encrypt($value->id))}}" class=""><span class=""></span>
